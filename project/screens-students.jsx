...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  body{background:#e8e8e8;font-family:'Noto Sans Khmer','Inter',sans-serif;}
  ...
  .sheet{width:210mm;min-height:297mm;margin:58px auto 30px;background:#fff;padding:12.7mm;box-shadow:0 6px 30px rgba(0,0,0,.18);}
  h1{font-size:18px;color:#1A4F96;}
  .sub{font-size:13px;color:#333;margin:2px 0 14px;}
  table{width:100%;border-collapse:collapse;font-size:12px;}
  th{background:#f0f0ee;text-align:left;padding:7px 8px;border:1px solid #ddd;font-size:11px;color:#555;-webkit-print-color-adjust:exact;print-color-adjust:exact;}
